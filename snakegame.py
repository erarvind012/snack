...
red = (201, 18, 18)
yellow = (239,250,32) 
dis_width = 1244    #set the size of screen width
dis_height = 686    #set the size of screen height 
dis = pygame.display.set_mode((dis_width,dis_height))
pygame.display.set_caption("Snake game")
clock = pygame.time.Clock()
snake_block = 10
snake_speed = 8      # manage the speed 
...
def main_game():
    ...
    while not game_over:
        while game_close == True:
            dis.fill(white)
            message("You lost! press p to play again q to quit",green)
            message("arvind kumar",red)
